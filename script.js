...
function passlist()
{
 var url = "https://olsonlist.github.io/index.html?list="+ shoppinglist;
...
var btnsharelist = '<input class="button" id="shares" name="shares" type="submit" value="Share Bird Watching List" onclick="share()" />';
TheRow = '<li>' + shoppinglist[i] + btndelete + ' '  + btnaddcart + '</li>';
TheList += TheRow;
}
//v3.1 add Title
...
if (arrayLength > 0)
{
  document.getElementById("labels").innerHTML = 'Seen';
